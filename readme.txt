...
== Installation ==
1. Upload `cc-cookie-consent` to the `/wp-content/plugins/` directory
...
= 1.0.1 =
* CC Cookie Consent stable version, see the changelog for the details

= 1.0.0 =
* CC Cookie Consent stable version

== Frequently Asked Questions ==
**[Go to the official Github repo](https://github.com/progcode/WPCookieConsent)**.
